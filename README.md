...
python evaluate.py --dataset s3dis --model ./model/model_best_s3dis.pth
```` 
...
| :---: | :---: | :---: |:-------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------:|
| **PCM** | S3DIS | 79.33% |  [config](https://github.com/PointCouplingMode/PCM/configs/s3dis/s3dis.yaml)  |         [Download](https://github.com/PointCouplingMode/PCM/releases)         |   [link](https://github.com/PointCouplingMode/PCM/tools/exp/default/ExpRecordl/s3dis.log)   |
| **PCM** | ScanNetV2 | 79.24% | [config](https://github.com/PointCouplingMode/PCM/configs/scannet/semseg-pt-v3m1-0-base.yaml) |       [Download](https://github.com/PointCouplingMode/PCM/releases)       | [link](https://github.com/PointCouplingMode//PCMtools/exp/default/ExpRecordl/scannetv2.log) |
